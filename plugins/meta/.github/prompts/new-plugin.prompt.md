...
---
<!-- AUTO-GENERATED by scripts/generate.mjs — do not edit by hand. Source: commands/new-plugin.md -->


Scaffold a new plugin in `plugins/<name>/` for this marketplace. Steps:

1. Ask for the plugin name (kebab-case), a one-line description, and a category if not provided in `${input:arguments}`.
